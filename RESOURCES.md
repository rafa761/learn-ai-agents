...
- [Book: _Introduction to Information Retrieval_ — Manning, Raghavan & Schütze (Cambridge UP 2008), ch. 8 "Evaluation in information retrieval"](https://nlp.stanford.edu/IR-book/html/htmledition/evaluation-in-information-retrieval-1.html)
  Free complete online edition of the standard IR textbook — the home discipline of recall/precision and ranked-retrieval evaluation. Lesson 0007's web primary: set-based vs ranked evaluation, averaging conventions, where MRR sits among rank-based measures. Verified live 2026-09-11. Companion: our [metrics-by-hand cheat sheet](reference/metrics-by-hand.html).
